...
* **`init()`** - This is called at the begining of a loop or apply 
    function.  It shouldcontain the code to actually create and 
...
* **`step(n=1L, ..., keep.open=FALSE)`** - This is called to increment
    ...
    stay open to show relevent information, such as total time or 
...
This project was insipred by a post to [R-Bloggers](https://www.r-bloggers.com/purrring-progress-bars-adding-a-progress-bar-to-purrrmap/) by Adi Sarid.  Credit goes to him for the original idea on which `purrrogress` is built.
